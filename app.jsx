...
const THEME_KEY = "llm_book_theme";
const PROGRESS_KEY = "llm_book_progress";
  ...
  return (
    <LangContext.Provider value={lang}>
      <div data-screen-label={screenLabel}>
        ...
        <div className="running-label">{screenLabel} · weights &amp; tokens · 2026</div>
